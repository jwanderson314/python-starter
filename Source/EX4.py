#Create a program that counts the number of times the word Python appears 
# in the text below and writes the result to the console. Do not use the string.count() method.
